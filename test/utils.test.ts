...
import type { CollectionCard, YGOCardSet, OwnedEdition } from '../src/types'
...
describe('deriveFrSets', () => {
  it('converts EN codes to FR', () => {
    const sets: YGOCardSet[] = [
      { set_code: 'MP25-EN007', set_name: 'X', set_rarity: 'C', set_price: '0' },
      { set_code: 'OTHER-XX1', set_name: 'Y', set_rarity: 'C', set_price: '0' },
    ]
...
describe('defaultEditionFromSets', () => {
  it('prefers FR sets first', () => {
    const fr: YGOCardSet[] = [{ set_code: 'MP25-FR007', set_name: 'FR', set_rarity: 'C', set_price: '0' }]
    const all: YGOCardSet[] = [{ set_code: 'MP25-EN007', set_name: 'EN', set_rarity: 'C', set_price: '0' }]
